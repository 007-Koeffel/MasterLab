...
write_xlsx(data_final_beta, path = "~/ML_in_Finance/Köffel/MasterLab/MasterLab/R_Export_dec.xlsx", col_names = TRUE, format_header = TRUE)
```
...
```{r Overview of the several beta calculations}
